...
require(dockerfile, r"confirmModulesPurge=false", "pnpm maintenance commands must work without an interactive TTY")
require(dockerfile, r"NPM_CONFIG_USERCONFIG=/opt/dsh-pnpmrc", "pnpm must read its noninteractive maintenance config outside the mounted home")
