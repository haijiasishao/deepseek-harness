...
require(dockerfile, r"CI=\$\{CI:-true\}.*corepack pnpm", "pnpm must default to noninteractive behavior in the container")
require(dockerfile, r"CI=\$\{CI:-true\}.*corepack pnpx", "pnpx must default to noninteractive behavior in the container")
